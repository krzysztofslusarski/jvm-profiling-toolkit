...
public interface JfrCollapsedParser {
    JfrCollapsedParsedFile parseCollapsed(List<Path> jfrFiles, List<PreStackFilter> filters, Set<AdditionalLevel> additionalLevels);

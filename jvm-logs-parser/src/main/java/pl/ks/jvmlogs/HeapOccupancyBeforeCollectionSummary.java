...
@Collates(HeapOccupancyBeforeCollectionAggregator.class)
public class HeapOccupancyBeforeCollectionSummary implements HeapOccupancyBeforeCollectionAggregation {

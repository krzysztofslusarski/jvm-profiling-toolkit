...
public class XYComplexDataSet {
    private final List<Point> dataSeries;

    public XYComplexDataSet() {
        dataSeries = new ArrayList<>();
    }

    public XYComplexDataSet(XYComplexDataSet series) {
    ...
    public XYComplexDataSet scaleSeries(double scaleFactor) {
        XYComplexDataSet scaled = new XYComplexDataSet();
    ...
    public XYComplexDataSet scaleAndTranslateXAxis(double scale, double offset) {
        XYComplexDataSet translatedSeries = new XYComplexDataSet();

...
@Builder
@AllArgsConstructor
public class SafepointParserOperationLog {
    ...
    SafepointParserOperationLog(BigDecimal timeStamp, long sequenceId) {
        this.timeStamp = timeStamp;
        this.sequenceId = sequenceId;
    }

    SafepointParserOperationLog(BigDecimal timeStamp, long sequenceId, BigDecimal applicationTime) {
        this.timeStamp = timeStamp;
        this.sequenceId = sequenceId;
